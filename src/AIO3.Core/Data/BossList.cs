...
{
    /// <summary>Creature entry IDs treated as bosses. Ported verbatim from the old AIO BossList.</summary>
    public static class BossList
    {
        public static bool Contains(int entry) => Entries.Contains(entry);

        public static readonly HashSet<int> Entries = new HashSet<int>
        {
